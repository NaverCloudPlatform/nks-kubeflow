                ...
                "spec": {
                    ...
                    "template": {
                        ...
                        "spec": {
                            "containers": [{
                                "image":
                                "io.kr.private-ncr.ntruss.com/ncp-kf-install-registry/ml-pipeline/visualization-server:" +
                                kfp_version,
                                "imagePullPolicy":
                                "IfNotPresent",
                                "name":
                    ...
                    "template": {
                        ...
                        "spec": {
                            "containers": [{
                                ...
                                "image":
                                "io.kr.private-ncr.ntruss.com/ncp-kf-install-registry/ml-pipeline/frontend:" + kfp_version,
                                "imagePullPolicy":
                                "IfNotPresent",
                                "ports": [{
                                    "containerPort": 3000
